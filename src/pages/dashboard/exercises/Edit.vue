    ...
    <div class="col-xs-12 col-md-12">
      <q-card class="q-mb-sm">
        ...
        <q-card-section>
          ...
          <q-separator />
          <q-card-section>
            <q-icon name="insert_photo" /> Portada Actual
          </q-card-section>
          <div class="row">
            <q-card>
              <q-card-section>
                <q-avatar size="12rem" square>
                  <img :src="portada.mediaLink" />
                </q-avatar>
              </q-card-section>
            </q-card>
          </div>
        ...
        <q-card-section class="row">
          <q-card class="col-sm-12 col-md-6 q-pa-sm">
            <FileUploadPreview
              :files="vform.portada"
              label="Cambiar portada de Ejercicio"
              class="col-md-6"
              spinner-color="white"
